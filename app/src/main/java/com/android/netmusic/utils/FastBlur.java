...
/**
 * 对图片进行模糊化处理
 * Created by 91905 on 2016/8/21 0021.
 */
...
//        int mArrayColorLenght = mBitmapHeight * mBitmapWeight;
        for (int i = 0; i < mBitmapHeight; i++) {
            for (int j = 0; j < mBitmapWeight; j++) {
//                System.out.println("i="+i+",j="+j+",weight="+mBitmapWeight+",height="+mBitmapHeight);
                int color = bitmap.getPixel(j,i);
                if (color >= Color.rgb(200, 200, 200) && color <= Color.rgb(255, 255, 255)) {
                    bitmap.setPixel(j, i, Color.rgb(190, 190, 190));
                }
            }
        }
