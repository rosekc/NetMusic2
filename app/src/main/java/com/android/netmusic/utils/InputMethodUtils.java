...
import com.android.netmusic.view.CloseKeyboardOnOutsideContainer;
...
public class InputMethodUtils {
    ...
    public static void detectKeyboard(ChatActivity activity) {
     ...
     */
    public static void detectKeyboard(final ChatActivity activity, final OnKeyboardEventListener listener) {
